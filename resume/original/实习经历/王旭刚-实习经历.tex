...
\newcommand{\intershipUptoday}[3] {
    \vspace{2pt}

	\parbox{\mpwidth}{
		\begin{tabular*}{1\mpwidth}{p{0.69\mpwidth}  r}
            {\Large \textcolor{black}{\textbf{#2}}} & \colorbox{maincol}{\makebox[0.25\mpwidth]{\textcolor{white}{\textbf{#1}}}} \\
		\end{tabular*}\\
	}
    \begingroup
        \setlength{\baselineskip}{15pt}
